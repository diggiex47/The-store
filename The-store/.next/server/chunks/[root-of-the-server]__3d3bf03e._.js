...
"[project]/.next-internal/server/app/api/auth/check-status/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
var { g: global, __dirname } = __turbopack_context__;
{
// Location: app/api/auth/check-status/route.ts
__turbopack_context__.s({
    "POST": (()=>POST)
});
...
async function POST(req) {
    try {
        ...
        // This query finds the user by either their email or their username.
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
            where: {
                OR: [
                    ...
                    {
                        name: email
                    } // Assuming the input can be email or username
                ]
            }
        });
        // If no user is found with that email or username.
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: "not_found"
            }, {
        ...
        // If the user is found but has not verified their email yet.
        if (!user.emailVerified) {
            // We return the "unverified" status AND their real email address.
            // This is crucial for the frontend to create the correct redirect URL.
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: "unverified",
                email: user.email
            });
        }
        // If the user is found and is fully verified.
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: "verified"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d3bf03e._.js.map
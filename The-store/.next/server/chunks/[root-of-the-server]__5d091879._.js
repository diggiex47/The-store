...
"[project]/.next-internal/server/app/api/register/verify/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/register/verify/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        //checking the email coming or not!!
        if (!email || !otp) {
            console.log("the email is ", email);
            console.log("the otp is ", otp);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Email or OTP are required"
            }, {
                status: 400
            });
        }
        //Checking the uesr is verified or not
        ...
        //Now find token and associated with the user
        const verifyToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verificationToken.findFirst({
            where: {
                userId: user.id
            },
            orderBy: {
        ...
        if (!verifyToken) {
            console.log("the email is ", email);
            console.log("the otp is ", otp);
            console.log("verifytoken failed", verifyToken);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        console.log(`Found token in DB: ${verifyToken.token}`);
        //now check the opt comparing the given otp with stored in database one
        const isOtpValid = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(otp, verifyToken.token);
        console.log(`Is OTP valid after bcrypt.compare? ${isOtpValid}`);
        if (!isOtpValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "OTP  not valid "
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d091879._.js.map
    ...
    callbacks: {
        async jwt ({ token, user }) {
            ...
            if (!token.apiToken && token.id) {
                ...
                const encryptionKey = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["hkdf"])("sha256", Buffer.from(secret, "base64"), "next-auth-encryption", "NextAuth.js Generated Encryption Key", 32, (err, encryptionKey)=>{
                    if (err) throw err;
                    console.log(Buffer.from(encryptionKey).toString('hex')); // '24156e2...5391653'
                });
                const apiToken = await new EncryptJWT({
                    sub: String(token.id),
                    email: token.email,
                    name: token.name
                }).setProtectedHeader({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95fe3142._.js.map
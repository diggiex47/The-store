...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/jsonwebtoken/index.js [app-route] (ecmascript)"); // Ensure you have run `npm install jsonwebtoken`
;
;
;
;
...
const authOptions = {
    ...
    jwt: {
        async encode ({ secret, token }) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign(token, secret, {
                algorithm: 'HS256'
            });
        },
    ...
    callbacks: {
        async jwt ({ token, user }) {
            ...
            const remember = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).get("rememberMe")?.value === "true";
            if (remember) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9ad9afb3._.js.map
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "eca5d13e743fe225d3e7c63649cae131c72fbce9b3f1af146dbff2638cf4486a",
    "copyEngine": true
};
...
async function POST(req) {
    try {
        ...
        // Step 1: Perform database operations in a transaction with explicit logic.
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
            let user;
            // We use the `existingUser` variable we fetched earlier to decide our action.
            if (existingUser) {
                // If the user exists (and we know they are unverified from our check above), UPDATE them.
            ...
            // The rest of the logic is the same: clear old tokens and create a new one.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c03c4699._.js.map
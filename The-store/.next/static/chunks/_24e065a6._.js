...
async function login(email, password) {
    ...
    if (!res.ok) {
        // If the server responds with an error (401, 500),
        // parse the error message from the Go backend's response body.
...
async function getMe() {
    ...
    if (!res.ok) {
        // This will happen if the user is not logged in (401 error)
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api.js [app-client] (ecmascript)"); // This function calls GET /api/auth/me
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            async function checkLoggedIn() {
                try {
                    const currentUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMe"])();
                    if (currentUser) {
                        setUser(currentUser);
                    }
                } catch (error) {
                    // If getMe fails (e.g., 401 error), user is null
                    setUser(null);
                }
                setLoading(false);
            }
...
//# sourceMappingURL=_24e065a6._.js.map
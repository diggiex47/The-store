...
"[project]/src/app/chat-test/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ChatTestPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatTestPage.useEffect": ()=>{
            // This function sets up the WebSocket connection.
            const connectToChat = {
                "ChatTestPage.useEffect.connectToChat": async ()=>{
                    if (status === "authenticated") {
                        try {
                            ...
                            ws.onopen = ({
                                "ChatTestPage.useEffect.connectToChat": ()=>{
                            ...
                            ws.onmessage = ({
                                "ChatTestPage.useEffect.connectToChat": (event)=>{
                                    try {
                                        // Parse the incoming JSON string into a ChatMessage object.
                                        const messageData = JSON.parse(event.data);
                                        setMessages({
                                            "ChatTestPage.useEffect.connectToChat": (prev)=>[
                                                    ...prev,
                                                    messageData
                                                ]
                                        }["ChatTestPage.useEffect.connectToChat"]);
                            ...
                            setSocket(ws);
                            return ({
                                "ChatTestPage.useEffect.connectToChat": ()=>ws.close()
                            })["ChatTestPage.useEffect.connectToChat"];
                        } catch (err) {
...
_s(ChatTestPage, "uDc7o9OZ2V78u1IJME+naS6Zvfc=", false, function() {
    return [
...
_c = ChatTestPage;
var _c;
__turbopack_context__.k.register(_c, "ChatTestPage");
...
//# sourceMappingURL=_25d0e5aa._.js.map
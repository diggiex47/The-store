...
function Chat() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Chat.useEffect": ()=>{
            ...
            ws.onopen = ({
                "Chat.useEffect": ()=>setConnectionStatus("Connected")
            })["Chat.useEffect"];
            ws.onmessage = ({
                "Chat.useEffect": (event)=>{
            ...
            ws.onerror = ({
                "Chat.useEffect": ()=>setConnectionStatus("Error: Connection failed.")
            })["Chat.useEffect"];
            ws.onclose = ({
                "Chat.useEffect": ()=>{
...
_s(Chat, "l+qvnJ6XLE50r+3ppYNcIavuUQc=", false, function() {
    return [
...
//# sourceMappingURL=src_app_chat-test_page_tsx_881f4e47._.js.map